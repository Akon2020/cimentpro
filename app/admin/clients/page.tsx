...
export default function ClientsPage() {
  ...
  const chiffreAffairesTotal = clients.reduce(
    (sum, c) => sum + c.chiffreAffaires,
    0
  );
  const commandesTotales = clients.reduce(
    (sum, c) => sum + c.totalCommandes,
    0
  );
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="particulier-pro">
                    Particulier Pro
                  </SelectItem>
                </SelectContent>
              </Select>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {Math.round((clientsActifs / clients.length) * 100)}% du
                portefeuille
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                €{chiffreAffairesTotal.toLocaleString()}
              </div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Moyenne: {Math.round(commandesTotales / clients.length)} par
                client
              </p>
            </CardContent>
          </Card>
                ...
                <TableBody>
                  {clients.map((client) => (
                    <TableRow key={client.id}>
                      ...
                      <TableCell>
                        {new Date(client.derniereCommande).toLocaleDateString(
                          "fr-FR"
                        )}
                      </TableCell>
                      <TableCell>
