...
import { Search, Filter, Plus, Eye, Edit, Trash2, Download, FileText } from "lucide-react"
...
const commandes = [
  {
    ...
    produitsDetailles: [
      { nom: "Ciment Portland", quantite: 30, prixUnitaire: 8500, total: 255000 },
      { nom: "Mortier", quantite: 20, prixUnitaire: 6800, total: 136000 },
    ],
    total: 391000,
  },
  {
    ...
    adresse: "456 Avenue Construction, Lyon\nFrance",
    notes: "",
    produitsDetailles: [
      { nom: "Ciment Blanc", quantite: 60, prixUnitaire: 12000, total: 720000 },
      { nom: "Ciment Rapide", quantite: 40, prixUnitaire: 9200, total: 368000 },
    ],
    total: 1088000,
  ...
  },
  {
    ...
    adresse: "123 Rue Example, Paris\nFrance",
    notes: "Livraison urgente",
    produitsDetailles: [{ nom: "Ciment Portland", quantite: 30, prixUnitaire: 8500, total: 255000 }],
    total: 255000,
  },
  {
    id: "CMD004",
    ...
    notes: "",
    produitsDetailles: [
      { nom: "Mortier", quantite: 60, prixUnitaire: 12000, total: 720000 },
      { nom: "Ciment Portland", quantite: 40, prixUnitaire: 9200, total: 368000 },
    ],
    total: 1088000,
    dateLivraison: "2024-01-16",
  },
  {
    ...
    adresse: "123 Rue Example, Paris\nFrance",
    notes: "Livraison urgente",
    produitsDetailles: [{ nom: "Ciment Blanc", quantite: 30, prixUnitaire: 8500, total: 255000 }],
    total: 255000,
  },
]

const handleDownloadBon = (commande: (typeof commandes)[0]) => {
  const formattedCommande = formatCommandeForPDF({
    ...commande,
    produits: commande.produitsDetailles || [
      {
        nom: commande.produits.join(", "),
        quantite: Number.parseInt(commande.quantite) || 1,
        prixUnitaire: commande.montant,
...
const handleDownloadFacture = (commande: (typeof commandes)[0]) => {
  const formattedCommande = formatCommandeForPDF({
    ...commande,
    produits: commande.produitsDetailles || [
      {
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => handleDownloadBon(commande)}
                          ...
                          {commande.statut === "Livré" && (
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => handleDownloadFacture(commande)}
