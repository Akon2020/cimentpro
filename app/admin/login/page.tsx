...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Pour la démo, on accepte admin@cimentpro.com / admin123
    if (formData.email === "admin@cimentpro.com" && formData.password === "admin123") {
      router.push("/admin/dashboard")
    } else {
      alert("Identifiants incorrects. Utilisez: admin@cimentpro.com / admin123")
    }
